...
React Router 是一个基于 [React](http://facebook.github.io/react/) 之上的强大路由库，它可以让你向应用中快速地添加视图和数据流，同时保持页面与 URL 间的同步。react-router 包介绍：
...
- [exact](https://reacttraining.com/react-router/web/api/Route/exact-bool)：绝对匹配
